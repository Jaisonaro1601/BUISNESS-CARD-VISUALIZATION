...
Original file is located at
    https://colab.research.google.com/drive/1c5B99FD9-hl5nb77g5spNs9p0iSK80Ge
"""
...
def extracted_text(texts):
  ...
  for i in range(2,len(texts)):
    if texts[i].startswith("+") or (texts[i].replace("-","").isdigit() and '-' in texts[i]):
      ...
      extrd_dict["ADDRESS"].append(remove_coln)
  for key ,value in extrd_dict.items():
    if len(value)>0:
      concat=" ".join(value)
      extrd_dict[key]=[concat]
    else:
      value="NA"
...
# st.title("Extracting Buisness Card Data With OCR")
# with st.sidebar:
...
!streamlit run OcrApp.py & npx localtunnel --port 8501
